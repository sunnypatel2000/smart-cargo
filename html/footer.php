	  				...
	  				<div class="col-xl-6">
	  					<form class="form-box">
	  						...
	  						<div class="input-area">
	  							<div class="input-box">
	  								<input type="text" placeholder="Enter email address here..." class="input-text">
	  							</div>
	  			...
	  			<div class="container">
	  				<div class="row">
	  					<div class="copy-right">
	  						<p>
	  							Copyright © SmartCargo.in All rights reserved
		...
		<div class="social-box">
			<ul class="social-list">
				<li>
					<a href="https://twitter.com/" class="social-link twitter" title="twitter">
						<i class="fab fa-twitter"></i>
					</a>
				</li>
				<li>
					<a href="https://www.facebook.com/" class="social-link facebook" title="facebook">
						<i class="fab fa-facebook-f"></i>
					</a>
				</li>
				<li>
					<a href="https://linkedin.com/" class="social-link linkdin" title="linkdin">
						<i class="fab fa-linkedin-in"></i>
					</a>
				</li>
				<li>
					<a href="https://www.youtube.com/" class="social-link youtube" title="youtube">
